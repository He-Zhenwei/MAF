...
#            rd['dc_label'] = flag
    ...
    if len(imdbs) == 2:
        t_source, imdb_s = get_roidb(imdbs[0])
        t_target, imdb_t = get_roidb(imdbs[1])
        ...
        target = []
        for t in t_target:
            gt_classes = t['gt_classes']
            max_classes = t['max_classes']
            boxes = t['boxes']
            max_overlaps = t['max_overlaps']
            gt_overlaps = t['gt_overlaps']
